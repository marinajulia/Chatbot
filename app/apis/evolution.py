...
def processar_imagem(instance:str, message_id:str, ia_infos) -> str:
    ...
    imagem_transcript = "Imagem enviada: Não foi possivel trascrever a imagem, fale para o cliente que a imagem foi recebida, mas não conseguimos processar o conteúdo dela."
    ...
    try:
        ...
        if data.get("status_code") in [200, 201]:
            ...
            print(f"Imagem Transcrita: {imagem_transcript}", flush=True)

    except Exception as e:
        print(f"Erro ao processar a imagem: {e}", flush=True)
